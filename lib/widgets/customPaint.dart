...
class _CustomPaintWidgetState extends State<CustomPaintWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(
        children: [
          buildCanvas("Triangle using CustomPainter",
              TrianglePainter(context: context)),
          SizedBox(
            height: 15,
          ),
          buildCanvas("Rounded Rectangle using CustomPainter",
              RRectPainter(context: context)),
          SizedBox(
            height: 15,
          ),
          buildCanvas(
              "Circle using CustomPainter", CirclePainter(context: context)),
          SizedBox(
            height: 15,
          ),
          buildClockCanvas("AnimatedClock using CustomPainter",
              ClockPainter(context: context)),
        ],
      ),
    );
  }
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var minuteBrush = Paint()
      ...
      ..shader = RadialGradient(colors: [
        ...
        Theme.of(context).primaryColorLight.withBlue(100)
