...
class LinearProgressIndicatorSample extends StatefulWidget {
  const LinearProgressIndicatorSample({Key? key}) : super(key: key);

  @override
  State<LinearProgressIndicatorSample> createState() =>
      _LinearProgressIndicatorSampleState();
}

class _LinearProgressIndicatorSampleState
    extends State<LinearProgressIndicatorSample> with TickerProviderStateMixin {
  double _value = 0;
...
class LinearProgressIndicatorDescription extends StatelessWidget {
  const LinearProgressIndicatorDescription({Key? key}) : super(key: key);
