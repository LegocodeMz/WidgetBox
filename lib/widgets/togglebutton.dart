...
class ToggleButtonImplementation extends StatefulWidget {
  ...
  @override
  _ToggleButtonImplementationState createState() =>
      _ToggleButtonImplementationState();
}

class _ToggleButtonImplementationState
    extends State<ToggleButtonImplementation> {
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Text(
              'I am of different border radius!',
              style: TextStyle(fontSize: 25),
            ),
          ),
          Padding(
            padding: const EdgeInsets.only(top: 8, left: 80),
            child: ToggleButtons(
              children: [Icon(Icons.cake), Icon(Icons.drafts)],
              isSelected: _third,
              onPressed: (int index) {
                setState(() {
...
class ToggleButtonDescription extends StatefulWidget {
  ...
  @override
  _ToggleButtonDescriptionState createState() =>
      _ToggleButtonDescriptionState();
}
